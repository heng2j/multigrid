...
CONFIGURATIONS = {
    ...
    'MultiGrid-CompetativeRedBlueDoor-v3-CTCE-2v2': (CompetativeRedBlueDoorEnvV3, {'size': 8, "allow_agent_overlap": False, "has_obsticle" : True, "death_match" : False, "teams":{"red": 2, "blue": 2}, "agents": 4, "training_scheme" : "CTCE" }), # ,"blue": 2
    'MultiGrid-CompetativeRedBlueDoor-v3-DTDE-2v2': (CompetativeRedBlueDoorEnvV3, {'size': 8, "allow_agent_overlap": False, "has_obsticle" : True, "death_match" : False, "teams":{"red": 2, "blue": 2}, "agents": 4, "training_scheme" : "DTDE" }), # ,"blue": 2
